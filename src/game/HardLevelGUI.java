...
public class HardLevelGUI extends JFrame implements ActionListener {
    ...
    private void loadNextGame() {
        ...
        infoArea.setText("What is the value of the tomato?   Score: 0   Time Left: 20"); // Include time left
