...
public class MediumLevelGUI extends JFrame implements ActionListener {
    ...
    private void loadNextGame() {
        ...
        infoArea.setBackground(new Color(221, 0, 0));
        infoArea.setForeground(new Color(255, 255, 255));
        infoArea.setFont(new Font("Baskerville Old Face", Font.BOLD, 16));
        infoArea.setEditable(false);
        infoArea.setText("What is the value of the tomato?   Score: 0   Time Left: 30"); // Include time left
